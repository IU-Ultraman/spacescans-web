...
relative to the data root (e.g. `data_full/BG_WI/C4/...`), so the subfolder
...
pipeline-data/
├── data_full/
│   ├── BG_NDI/C4/    ndi_bg_acs5_..._xgboost.rds           (NDI — deployer artifact)
│   ├── BG_WI/C4/     epawalkind_nationwide_2016_2021.Rda   (Walkability — deployer artifact)
...
│   ├── County_FL/C3/ tl_2010_us_county10/*.shp             (Census county boundaries)
...
│   └── BG_FL/C3/     tiger2010_bg10_states/ , tiger2024_bg_states/  (Census block groups)
└── data/
    ├── CBP/C4/       cbp_nationwide_*.Rda , zbp_nationwide_*.Rda  (Community org density — deployer artifacts)
