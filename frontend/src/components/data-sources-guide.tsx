...
/**
 * Exposure-dataset acquisition guide. Rendered both on the standalone
    ...
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        ...
        <p className="max-w-3xl text-sm text-muted-foreground">
          ...
          <code className="rounded bg-muted px-1 py-0.5 text-xs">.Rda</code>) built
          from public sources by the project/collaborator — they can&apos;t be
